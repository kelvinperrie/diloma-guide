...
var snailData = [
    {
        ...
        details : [
            ...
            { text : "Found at low, mid, and high tides.", references : [] },

        ],
        images : [],
        references : [
            { id: 1, detail: "Carson, Sally & Morris (2022) Rod The New Zealand Seashore Guide (pp165). Potton & Burton" }
        ]
    },
    {
        ...
        details : [
            ...
            { text : "Spiral lines often very faded. Growth lines are well developed. ", references : [2] },
            { text : "Found in what habitat????. ", references : [] },
    ...
    },
    {
        ...
        details : [
            ...
            { text : "Spiral lines are well developed. Growth lines often faded. ", references : [] },
